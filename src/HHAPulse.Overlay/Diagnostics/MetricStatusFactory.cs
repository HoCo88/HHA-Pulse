...
public static class MetricStatusFactory
{
    public static List<MetricStatus> Create(TelemetrySnapshot snapshot)
    {
        ...
        var statuses = new List<MetricStatus>
        {
            ...
            Status(OverlayPresetCatalog.CpuClock, snapshot, now, traces),
            ...
            Status(OverlayPresetCatalog.StorageTemp, snapshot, now, traces),
            Status(OverlayPresetCatalog.StorageWear, snapshot, now, traces),
    ...
    private static bool IsMetricFlagAvailable(string metricId, TelemetrySnapshot snapshot)
    {
        return metricId switch
        {
            ...
            OverlayPresetCatalog.CpuClock => snapshot.AvailableMetrics.HasFlag(MetricFlags.CpuClock),
            ...
            OverlayPresetCatalog.StorageTemp => snapshot.AvailableMetrics.HasFlag(MetricFlags.StorageTemperature),
            OverlayPresetCatalog.StorageWear => snapshot.AvailableMetrics.HasFlag(MetricFlags.StorageWear),
