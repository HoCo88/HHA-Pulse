...
public static class MetricFormatter
{
    ...
    public static string FormatMetric(string metricId, TelemetrySnapshot snapshot)
    {
        return metricId switch
        {
            ...
            OverlayPresetCatalog.CpuClock => FormatAvailable(snapshot, MetricFlags.CpuClock, $"CPU {MetricFormatterCompact.FormatValue(OverlayPresetCatalog.CpuClock, snapshot)}", "CPU --"),
            ...
            OverlayPresetCatalog.StorageTemp => FormatAvailable(snapshot, MetricFlags.StorageTemperature, $"SSD {MetricFormatterCompact.FormatValue(OverlayPresetCatalog.StorageTemp, snapshot)}", "SSD --"),
            OverlayPresetCatalog.StorageWear => FormatAvailable(snapshot, MetricFlags.StorageWear, $"SSD {MetricFormatterCompact.FormatValue(OverlayPresetCatalog.StorageWear, snapshot)}", "SSD --"),
